            ...
            while (true) {
                switch (resourceId) {
                    case 1:
                        ...
                        table.mutex.acquire();
                        System.out.println("Pusher(1): Acquired mutex. Checking for pairs...");
                        ...
                        System.out.println("Pusher(1): Releasing mutex.");
                        table.mutex.release();
                        break;
                    ...
                    case 2:
                        ...
                        table.mutex.acquire();
                        System.out.println("Pusher(2): Acquired mutex. Checking for pairs...");
                        ...
                        System.out.println("Pusher(2): Releasing mutex.");
                        table.mutex.release();
                        break;
                    ...
                    case 3:
                        ...
                        table.mutex.acquire();
                        System.out.println("Pusher(3): Acquired mutex. Checking for pairs...");
                        ...
                        System.out.println("Pusher(3): Releasing mutex.");
                        table.mutex.release();
                        break;
                }
            }
